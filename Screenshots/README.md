...
| # | File | Description |
|---|---|---|
| 10 | [10-rdp-successful-authentication-command.png](https://github.com/priyanka-sec/Windows-RDP-Brute-Force-Detection-Lab/blob/main/Screenshots/10-rdp-successful-authentication-command.png) | xfreerdp successful auth command |
...
| # | File | Timestamp | Description |
|---|---|---|---|
| 24 | [24-splunk-all-sourcetypes-flowing.png](https://github.com/priyanka-sec/Windows-RDP-Brute-Force-Detection-Lab/blob/main/Screenshots/24-splunk-all-sourcetypes-flowing.png) | 26/05/2026 | All 4 log sources flowing into Splunk |
